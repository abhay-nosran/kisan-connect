...
import AuctionCardRow2 from "./AuctionCardRow2";
...
function Auctions2() {
    ...
    function registerHandler(auctionId , setCurrentPrice){
        cardsRef[auctionId] = setCurrentPrice ;
    }
    ...
    useEffect(()=>{
        ...
        async function handleSubscribe() {
            ...
            eventSource.addEventListener("message",(event)=>{
                ...
                const setter = cardsRef.current[message.auctionId] ;
                if(setter) setter(message.currentPrice)
...
useEffect(() => {
    // Update auctionsRef for all current auctions
    auctions.forEach(auction => {
        auctionsRef.current[auction.auctionId] = auction ;
        ...
        <div className="m-2">
            ...
            <div className="flex justify-evenly">
                ...
                <div className="w-3/4 space-y-4">
                    {Object.values(auctionsRef.current).length > 0
                        ? Object.values(auctionsRef.current).map(a => (
                            <AuctionCardRow2
                            key={a.auctionId}
                            auction={a}
                            setPlaceBidPopup={setPlaceBidPopup}
